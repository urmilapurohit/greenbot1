...
namespace FormBot.Main.Controllers
{
    public class AuthorizationController : Controller
    {
        ...
        public async Task<ActionResult> Callback(string code, string state)
        {
            ...
            if (((System.Uri)TempData["PreviousUrl"]).AbsolutePath.Contains("SAASInvoice"))
            {
                return RedirectToAction("Index", "SAASInvoice");
            }
            else if (((System.Uri)TempData["PreviousUrl"]).AbsolutePath.Contains("STCInvoice"))
            {
