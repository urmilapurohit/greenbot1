            ...
            foreach (var menu in menus)
            {
                ...
                if (menu.WithoutSubMenu)
                {
                    foreach (var menuDetail in menuDeailsWithoutSubMenu)
                    {
                        ...
                        output.Append(@"<li> <a class='navlink' href='" + url + "' title='Create New'> <i class='icon'> <img src='" + menu.Image + "' alt='Create New'> </i> " + menu.DisplayName + " </a></li>");
                    }
                }
                else
                {
                    if (menu.DisplayName == "Users")
                        output.Append(@"<li class='active'> <a class='navlink' href='javascript:void(0)' title='Create New'> <i class='icon'> <img src='" + menu.Image + "' alt='Create New'> </i> " + menu.DisplayName + " </a>");
                    else
                        output.Append(@"<li> <a class='navlink' href='#' title='Create New'> <i class='icon'> <img src='" + menu.Image + "' alt='Create New'> </i> " + menu.DisplayName + " </a>");
                    output.Append(@"<ul>");
