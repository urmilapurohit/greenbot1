...
(function (factory) {
    ...
    $.fn.dataTableExt.oApi.fnColReorder = function (oSettings, iFrom, iTo, drop, invalidateRows) {
        ...
        //    if (iFrom == visibleColCnt - 1 || iFrom == visibleColCnt - 2) {                
        //        return;
        //    }

        //    if (iTo == visibleColCnt - 1 || iTo == visibleColCnt - 2) {
        //        return;
        //    }
        //}
        //else {
        //    if (iFrom == visibleColCnt) {
        //        return;
        //    }
        //    if (iTo == visibleColCnt) {
        //        return;
        //    }
        //}

        //if (iFrom < 0 || iFrom >= visibleColCnt) {
        //    return;
        //}
        //if (iTo < 0 || iTo >= visibleColCnt) {
        //    return;
        //}
        ...
        if ((UserTypeID == 6) || (isAssignSSC == 'true' && ((UserTypeID == 4 && IsSSCReseller == 'true') || (UserTypeID == 8 && IsSubContractor == 'false' && IsSSCReseller == 'true')))) {
            if (iFrom == visibleColCnt - 1) {
                return;
            }

            if (iTo == visibleColCnt - 1) {
                return;
            }
        }       
