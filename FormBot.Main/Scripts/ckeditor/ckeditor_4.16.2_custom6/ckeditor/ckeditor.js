...
(function () {
            ...
            enlarge: function (a, b) {
                ...
                switch (a) {
                    ...
                    case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
                        ...
                        k = k.lastBackward();
                        w = w || h;
                        this.setStartAt(w, !w.is("br") && (!k && this.checkStartOfBlock() || k && w.contains(k)) ? CKEDITOR.POSITION_AFTER_START : CKEDITOR.POSITION_AFTER_END);
    ...
    (function () {
        ...
        function x(a, b, e, f) {
            ...
            if (f.doFilter) {
                ...
                if (!a || !a.valid) return e.push(b), 1; F = a.validAttributes;
                var O = a.validStyles;
                r = a.validClasses;
                var t = b.attributes,
                    B = b.styles,
    ...
    (function () {
        ...
        CKEDITOR.replace = function (b, d) {
            var instance = CKEDITOR.instances.contentusernoteeditor;
            if (instance) {
                //CKEDITOR.remove(instance);
                var ckeeditor = document.getElementById("cke_contentusernoteeditor");
                if (ckeeditor != null)
                    ckeeditor.setAttribute("display", "none");
            }
        ...
        CKEDITOR.replace = function (b, d) {
            ...
            if (instance) {
                //CKEDITOR.remove(instance);
                var ckeeditor = document.getElementById("cke_contenteditor");
                if (ckeeditor!=null)
                    ckeeditor.setAttribute("display", "none");
            }
            return a(b, d, null, CKEDITOR.ELEMENT_MODE_REPLACE);
        ...
        CKEDITOR.replace = function (b, d) {
            var instance = CKEDITOR.instances.notecontenteditor;
            if (instance) {
                //CKEDITOR.remove(instance);
                var ckeeditor = document.getElementById("cke_notecontenteditor");
                if (ckeeditor != null)
                    ckeeditor.setAttribute("display", "none");
            }
            return a(b, d, null, CKEDITOR.ELEMENT_MODE_REPLACE);
    ...
    */
    ...
    (function () {
        function d(a, b) {
            ...
            else this.editor.on("instanceReady", function () {
                this.attach()
            }, this);
            a.on("destroy", function () {
                this.destroy()
        ...
        d.prototype = {
            ...
            registerPanelNavigation: function () {
                ...
                this._listeners.push(a.attachListener(a, "keydown", function (a) {
                    this.onKeyDown(a)
                }, this, null, 5))
            },
            addAriaAttributesToEditable: function () {
                ...
                a.isInline() && (a.setAttribute("aria-controls", b), a.setAttribute("aria-activedescendant", ""), a.setAttribute("aria-autocomplete", "list"), a.setAttribute("aria-expanded", "false"))
            },
            updateAriaAttributesOnEditable: function (a) {
                var b =
                    this.editor.editable();
                a = a.data;
                b && b.isInline() && (b.setAttribute("aria-expanded", a ? "true" : "false"), a || b.setAttribute("aria-activedescendant", ""))
            },
            ...
            removeAriaAttributesFromEditable: function () {
                var a = this.editor.editable();
                a && a.isInline() && (a.removeAttributes(["aria-controls", "aria-expanded", "aria-activedescendant"]), a.setAttribute("aria-autocomplete", "none"))
            },
            close: function () {
            ...
            getModel: function (a) {
                ...
                return new f(function (c, k) {
                    return a.call(this, CKEDITOR.tools.extend({
                        autocomplete: b
                    }, c), k)
                })
            },
            ...
            onKeyDown: function (a) {
                if (this.model.isActive) {
                    var b = a.data.getKey(),
                        c = !1;
                    27 == b ? (this.close(), this.textWatcher.unmatch(), c = !0) : 40 == b ? (this.model.selectNext(), c = !0) : 38 == b ? (this.model.selectPrevious(), c = !0) :
                        -1 != CKEDITOR.tools.indexOf(this.commitKeystrokes, b) && (this.commit(), this.textWatcher.unmatch(), c = !0);
        ...
        g.prototype = {
            ...
            createItem: function (a) {
                a = h(a);
                a =
                    CKEDITOR.dom.element.createFromHtml(this.itemTemplate.output(a), this.document);
                ...
                var b = this.element.getWindow(),
                    ...
                    b = function (a) {
                        ...
                        editorViewportRect: function (a) {
                            var b =
                                a.editable();
                            return CKEDITOR.env.iOS && !b.isInline() ? a.window.getFrame().getParent().getClientRect(!0) : b.isInline() ? b.getClientRect(!0) : a.window.getFrame().getClientRect(!0)
                        }(this.editor),
                        caretRect: a,
        ...
        f.prototype = {
            ...
            selectNext: function () {
                if (null ==
                    this.selectedItemId) this.selectFirst();
                else {
    ...
    (function () {
        function h(b, d) {
            for (var a = b.length, c = 0, e = 0; e < a; e += 1) {
                var g = b[e];
                if (d >= c && c + g.getText().length >= d) return {
                    element: g,
                    offset: d - c
                };
                c += g.getText().length
        ...
        CKEDITOR.plugins.textMatch.match = function (b, d) {
            var a = CKEDITOR.plugins.textMatch.getTextAndOffset(b),
                ...
                e = 0;
            if (a) return 0 == a.text.indexOf(c) && (e = c.length,
                a.text = a.text.replace(c, ""), a.offset -= e), (c = d(a.text, a.offset)) ? {
        ...
        CKEDITOR.plugins.textMatch.getTextAndOffset = function (b) {
            ...
            var d = "",
                ...
                e = !1,
                g, h = b.startContainer.type != CKEDITOR.NODE_ELEMENT;
            g = h ? m(c, function (a) {
                return b.startContainer.equals(a)
            }) : b.startOffset - (c[0] ? c[0].getIndex() : 0);
            for (var k = c.length, f = 0; f < k; f +=
                1) {
                var l = c[f],
                    d = d + l.getText();
                e || (h ? f == g ? (e = !0, a += b.startOffset) : a += l.getText().length : (f == g && (e = !0), 0 < f && (a += c[f - 1].getText().length), k == g && f + 1 == k && (a += l.getText().length)))
            }
            return {
                text: d,
                offset: a
        ...
        CKEDITOR.plugins.textMatch.getAdjacentTextNodes = function (b) {
            ...
            var d = [],
                a, c, e;
            b.startContainer.type != CKEDITOR.NODE_ELEMENT ? (a = b.startContainer.getParent().getChildren(), b = b.startContainer.getIndex()) : (a = b.startContainer.getChildren(), b = b.startOffset);
    ...
    (function () {
        function h(a, b) {
            ...
            this.minChars = null !== b.minChars && void 0 !== b.minChars ? b.minChars : 2;
            var c;
            if (!(c = b.pattern)) {
                c = this.minChars;
        ...
        function m(a, b) {
            return function (d, c) {
                ...
                function h(b) {
                    var a = 1;
                    return CKEDITOR.tools.array.reduce(b, function (b, c) {
                        b.push({
                            name: c,
                            id: a++
                        });
                ...
                function e(a) {
                    a && (a = CKEDITOR.tools.array.map(a, function (a) {
                ...
                CKEDITOR.tools.array.isArray(a) ? g() : "string" === typeof a ? k() : a({
                    query: f,
                    marker: b.marker
                }, e)
            }
            ...
            f.addCommand("simage", {
                exec: function (d) {
                    ...
                    a.onchange = function () {
                        ...
                        5E6 < file.size ? (b = document.createElement("div"), b.className = "message alert alert-danger", m = document.createElement("span"), m.innerHTML = "Image size exceeded! Please upload image of less than 5 MB.", b.appendChild(m), c = document.createElement("span"), c.className = "close", c.style.marginTop = "-3px", c.setAttribute("data-dismiss", "alert"), c.innerHTML = "x", b.appendChild(c), e = document.querySelector(".error-space"), e.appendChild(b), setTimeout(function () {
                            ...
                            }, $(CKEDITOR.instances[curr.name]).trigger("imageUploaded")) : -1 === "jpeg jpg png svg gif tif svg+xml".split(" ").indexOf(file.type.split("/")[1]) ? (b = document.createElement("div"), b.className = "message alert alert-danger", m = document.createElement("span"), m.innerHTML = "The uploaded image format is not of acceptible format! Please upload an image!", b.appendChild(m),
                                c = document.createElement("span"), c.className = "close", c.setAttribute("data-dismiss", "alert"), c.style.marginTop = "-3px",  c.innerHTML =
                                "x", b.appendChild(c), e = document.querySelector(".error-space"), e.appendChild(b), setTimeout(function () {
                                    alert = document.querySelector(".alert-danger");
                                    alert.parentNode.removeChild(alert)
                                }, 2E4), c.onclick = function () {
                                    b = document.querySelector(".alert-danger");
                                    b.parentNode.removeChild(b)
                                }, $(CKEDITOR.instances[curr.name]).trigger("imageUploaded")) : (img = new Image, img.onload = function () {
                                    debugger;
                                    inputWidth = this.width;
                                    inputHeight = this.height
                                }, img.src = window.URL.createObjectURL(file), formData = new FormData, formData.append("file",
                                    file), loaderElem = new CKEDITOR.dom.element("loader-elem"), loaderHtmlStr = '\x3cdiv style\x3d"position: relative; z-index: 100;width: 100%;height: 100%;text-align: center;background: white;opacity: 0.75;pointer-events:none"\x3e\x3cimg src\x3d"/images/loading2.gif" style\x3d"width: 30px;height: 30px;margin-top: 100px;"\x3e\x3c/div\x3e', loaderDomEle = CKEDITOR.dom.element.createFromHtml(loaderHtmlStr), loaderElem.append(loaderDomEle), d.insertElement(loaderElem), CKEDITOR.currentInstance.setReadOnly(!0),
                                    $.ajax({
                                        url: d.config.imageUploadURL,
                                        type: "POST",
                                        data: formData,
                                        processData: !1,
                                        contentType: !1
                                        ...
                                        return function (g, f, h) {
                                            // g = JSON.parse(g);
                                            g.success &&
                                                (CKEDITOR.instances[curr.name].setReadOnly(!1), url = g.url, elem = new CKEDITOR.dom.element("elem"), maxWidth = Math.min(inputWidth, 600), maxHeight = Math.min(inputHeight, 600), maxWidth / maxHeight > inputWidth / inputHeight ? (width = maxWidth * inputWidth / inputHeight, height = maxHeight) : maxWidth / maxHeight < inputWidth / inputHeight ? (width = maxWidth, height = maxHeight *
                                                inputHeight / inputWidth) : (width = maxWidth, height = maxHeight), newLine = CKEDITOR.dom.element.createFromHtml("\x3cp\x3e\x3cbr\x3e\x3c/p\x3e"), imgElem = '\x3cimg src\x3d"' + url + '" class\x3d"image-editor" data-width\x3d"' + inputWidth + '" data-height\x3d"' + inputHeight + '" height\x3d"' + height + '" width\x3d"' + width + '"\x3e', imgDomElem = CKEDITOR.dom.element.createFromHtml(imgElem), elem.append(imgDomElem), d.insertElement(newLine), d.insertElement(elem), d.insertElement(newLine), loaderElem.remove(), $(CKEDITOR.instances[curr.name]).trigger("imageUploaded"))
                                        }
                                    }(this)).error(function (d) {
                                        return function (d,
                                            f, h) {
                                            CKEDITOR.instances[curr.name].setReadOnly(!1);
                                            ...
                                            c.setAttribute("data-dismiss", "alert");
                                            c.innerHTML = "x";
                                            b.appendChild(c);
    ...
    CKEDITOR.config.plugins = 'basicstyles,button,toolbar,enterkey,entities,floatingspace,wysiwygarea,indent,indentlist,dialogui,dialog,fakeobjects,link,list,undo,panel,floatpanel,textwatcher,autocomplete,textmatch,xml,ajax,mentions,blockquote,listblock,richcombo,format,image,mentions,editorplaceholder,ajax,cloudservices,easyimage,popup,filebrowser,simage';
    ...
    (function () {
        ...
        if (CKEDITOR.env.hidpi) setIcons('bold,0,,italic,24,,strike,48,,subscript,72,,superscript,96,,underline,120,,indent-rtl,144,,indent,168,,outdent-rtl,192,,outdent,216,,anchor-rtl,240,,anchor,264,,link,288,,unlink,312,,bulletedlist-rtl,336,,bulletedlist,360,,numberedlist-rtl,384,,numberedlist,408,,blockquote,528,,simage,552, ,easyimagealigncenter,696,,easyimagealignleft,720,,easyimagealignright,744,,easyimagealt,768,,easyimagefull,792,,easyimageside,816,,easyimageupload,840,,auto', 'icons_hidpi.png');
        else setIcons('bold,0,auto,italic,24,auto,strike,48,auto,subscript,72,auto,superscript,96,auto,underline,120,auto,indent-rtl,144,auto,indent,168,auto,outdent-rtl,192,auto,outdent,216,auto,anchor-rtl,240,auto,anchor,264,auto,link,288,auto,unlink,312,auto,bulletedlist-rtl,336,auto,bulletedlist,360,auto,numberedlist-rtl,384,auto,numberedlist,408,auto,blockquote,528,auto,simage,552,auto,easyimagealigncenter,696,auto,easyimagealignleft,720,auto,easyimagealignright,744,auto,easyimagealt,768,auto,easyimagefull,792,auto,easyimageside,816,auto,easyimageupload,840,auto', 'icons.png');
    })();
    ...
    CKEDITOR.replace('contentusernoteeditor', {
        extraPlugins: 'editorplaceholder',
        editorplaceholder: 'Add a note about to inform anything',
        removeButtons: 'Cut,Copy,Paste,Undo,Redo,Anchor,Underline,Strike,Subscript,Superscript',
        imageUploadURL: '/user/uploadImageCkeditor?UserID=' + UserIDforckeditor
    });
   

CKEDITOR.replace('contentusernoteeditor', {
    extraPlugins: 'editorplaceholder',
    editorplaceholder: 'Add a note about this deal,Mention someone by using "@" infront of their name to notify them about it.',
    removeButtons: 'Cut,Copy,Paste,Undo,Redo,Anchor,Underline,Strike,Subscript,Superscript',
    imageUploadURL: '/user/uploadImageCkeditor?UserID=' + UserIDforckeditor
});
...
CKEDITOR.replace('contenteditor', {
    ...
    editorplaceholder: 'Add a note about this deal,Mention someone by using "@" infront of their name to notify them about it.',
    removeButtons: 'Cut,Copy,Paste,Undo,Redo,Anchor,Underline,Strike,Subscript,Superscript',
    imageUploadURL: '/job/uploadImageCkeditor?jobId=' + jobid
});
CKEDITOR.replace('notecontenteditor', {
    extraPlugins: 'editorplaceholder',
    editorplaceholder: 'Add a note about this deal,Mention someone by using "@" infront of their name to notify them about it.',
    removeButtons: 'Cut,Copy,Paste,Undo,Redo,Anchor,Underline,Strike,Subscript,Superscript',
    imageUploadURL: '/job/uploadImageCkeditor?jobId=' + jobid
