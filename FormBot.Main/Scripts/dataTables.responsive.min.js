...
(function (c) {
    ...
    c.extend(j.prototype, {
        ...
        _resize: function () {
            ...
            var arr = [];
            var bvalue = d > a.c.details.sWidth ? true : false;
            for (var u = 0; u < h.length; u++) {
                arr.push(bvalue);
            }

            var i = arr;
            //r i = this._columnsVisiblity(f);
            // End
            this.s.current = i;
            e = !1;
            g = 0;
    ...
    j.display = {
        ...
        childRowImmediate: function (a, b, d) {
            if (!b && a.child.isShown() || !a.responsive.hasHidden()) return a.child(!1), c(a.node()).removeClass("parent"),
                //Added By Vishal - To remove parent row
                //c(a.node()).show(),
                //Ended - To remove parent row
                !1;
            a.child(d(), "child").show();
            c(a.node()).addClass("parent");
            //Added By Vishal - To remove parent row
