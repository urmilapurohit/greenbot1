...
function SnackBar(userOptions) {
    ...
    function _Create() {
        ...
        $(_Element).attr("SnackbarId", _Options.SnackbarId);
        ...
        _Options.message = $("<div/>").html(_Options.message).text();
        _Message = document.createElement("div");
        _Message.classList.add("js-snackbar__message");
        _Message.innerHTML = _Options.message;
      
        _title = document.createElement("div");
        _title.classList.add("js-snackbar_title");
        _title.innerHTML = _Options.NotificationTitle;

        innerSnack.appendChild(_title);
        innerSnack.appendChild(_Message);
        if (_Options.NotificationTitle === undefined) {
            _Message.classList.remove("js-snackbar__message");
            _Message.classList.add("js-snackbar__messagewithoutTitle");
        }
        if (_Options.SnackbarId === "gstsnackbar") {
            _Message.classList.add("js-snackbar__message");
        }
    ...
    var _ConfigureDefaults = function () {
        ...
        _Options.SnackbarId = userOptions.SnackbarId;
        _Options.NotificationTitle = userOptions.NotificationTitle;
        if (userOptions.message !== undefined) {
            _Options.message = userOptions.message;
        }
        //if (userOptions.NotificationTitle !== "abc") {
        //    _Message.classList.remove("js-snackbar__message");
        //    _Element.style.paddingTop = "-26px";
        //}
    ...
    this.Close = function () {
        ...
        //$(_Element).attr("id", "snackbar_" + _Options.id);
        if (!isNaN(_Options.SnackbarId)) {
            SetsnackbarSession(_Options.SnackbarId);
        }
