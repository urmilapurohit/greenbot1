...
var VEECInstalltionInfo = [];
$(document).ready(function () {
    var VEECInstallationPostalAddressID = typeof modelVEECInstallationDetailPostalAddressID != "undefined" ? modelVEECInstallationDetailPostalAddressID : 0;
    var VEECInstallationUnitTypeID = typeof modelVEECInstallationDetailUnitTypeID != "undefined" ? modelVEECInstallationDetailUnitTypeID : 0;
    var VEECInstallationStreetTypeID = typeof modelVEECInstallationDetailStreetTypeID != "undefined" ? modelVEECInstallationDetailStreetTypeID : 0;
    var VEECInstallationDetailIndustryBusinessType = typeof modelVEECInstallationDetailIndustryBusinessType != "undefined" ? modelVEECInstallationDetailIndustryBusinessType : 0;
    var VEECDetailScheduleActivityType = typeof modelVEECDetailScheduleActivityType != "undefined" ? modelVEECDetailScheduleActivityType : 0;
   
    dropDownData = [];
    dropDownData.push(
        { id: 'VEECInstallationDetail_UnitTypeID', key: "UnitType", value: VEECInstallationUnitTypeID, hasSelect: true, callback: null, defaultText: null, proc: 'UnitType_BindDropdown', param: [], bText: 'UnitTypeName', bValue: 'UnitTypeID' },
        { id: 'VEECInstallationDetail_StreetTypeID', key: "StreetType", value: VEECInstallationStreetTypeID, hasSelect: true, callback: null, defaultText: null, proc: 'StreetType_BindDropdown', param: [], bText: 'StreetTypeName', bValue: 'StreetTypeID' },
        { id: 'VEECInstallationDetail_PostalAddressID', key: "PostalAddress", value: VEECInstallationPostalAddressID, hasSelect: true, callback: null, defaultText: null, proc: 'PostalAddress_BindDropdown', param: [], bText: 'PostalDeliveryType', bValue: 'PostalAddressID' },
        { id: 'VEECDetail_ScheduleActivityType', key: "ScheduleActivityType", value: VEECDetailScheduleActivityType, hasSelect: true, callback: null, defaultText: null, proc: 'ScheduleActivityType_BindDropdown', param: [], bText: 'ScheduleActivityTypeName', bValue: 'ScheduleActivityTypeId' },
        { id: 'createVEEC_VEECDetail_ScheduleActivityType', key: "ScheduleActivityType", value: "", hasSelect: true, callback: null, defaultText: null, proc: 'ScheduleActivityType_BindDropdown', param: [], bText: 'ScheduleActivityTypeName', bValue: 'ScheduleActivityTypeId' },
        { id: 'createVEEC_VEECInstallationDetail_UnitTypeID', key: "UnitType", value: "", hasSelect: true, callback: null, defaultText: null, proc: 'UnitType_BindDropdown', param: [], bText: 'UnitTypeName', bValue: 'UnitTypeID' },
        { id: 'createVEEC_VEECInstallationDetail_StreetTypeID', key: "StreetType", value: "", hasSelect: true, callback: null, defaultText: null, proc: 'StreetType_BindDropdown', param: [], bText: 'StreetTypeName', bValue: 'StreetTypeID' },
        { id: 'createVEEC_VEECInstallationDetail_PostalAddressID', key: "PostalAddress", value: "", hasSelect: true, callback: null, defaultText: null, proc: 'PostalAddress_BindDropdown', param: [], bText: 'PostalDeliveryType', bValue: 'PostalAddressID' },
        { id: 'VEECInstallationDetail_IndustryBusinessType', key: "IndustryBusinessType", value: VEECInstallationDetailIndustryBusinessType, hasSelect: true, callback: SetVEECInstallationInfo, defaultText: null, proc: 'IndustryBusinessType_BindDropdown', param: [], bText: 'IndustryBusinessTypeName', bValue: 'IndustryBusinessTypeId' },
        { id: 'createVEEC_VEECInstallationDetail_IndustryBusinessType', key: "IndustryBusinessType", value: "", hasSelect: true, callback: DisplayVEECInstallationInfo, defaultText: null, proc: 'IndustryBusinessType_BindDropdown', param: [], bText: 'IndustryBusinessTypeName', bValue: 'IndustryBusinessTypeId' });
    dropDownData.bindDropdown();
    AddressAutoComplete('#createVEEC_VEECInstallationDetail_Town', '#createVEEC_VEECInstallationDetail_State', '#createVEEC_VEECInstallationDetail_PostCode');
    AddressAutoComplete('#VEECInstallationDetail_Town', '#VEECInstallationDetail_State', '#VEECInstallationDetail_PostCode');
   // AddressAutoComplete('#VEECInstaller_Town', '#VEECInstaller_State', '#VEECInstaller_PostCode');
    $(document).on('click', "#saveCreateVEECPopup", function () {
        if ($("#createVEECPopup").valid()) {
            var json = {};
            //var data = JSON.stringify($('#createVEECPopup').serializeToJson());
            //var data = $('#createVEECPopup').serialize()
            var data = form2js('createVEECPopup', '.', true, null);
            if ($('#createVEEC_VEECOwnerDetail_IsPostalAddress').val() == 1) {
                data.createVEEC.VEECOwnerDetail.IsPostalAddress = false
            } else {
                data.createVEEC.VEECOwnerDetail.IsPostalAddress = true
            }
            if ($('#createVEEC_VEECInstallationDetail_IsPostalAddress').val() == 1) {
                data.createVEEC.VEECInstallationDetail.IsPostalAddress = false
            } else {
                data.createVEEC.VEECInstallationDetail.IsPostalAddress = true
            }
            $.ajax(
            {
                url: urlCreateVEECPopup,
                dataType: 'json',
                ...
                success: function (response) {
                    if (!(response.error)) {
                        ...
                        var data = response.veecName;
                        $('#popupboxCreateVEECPopup').modal('toggle');
                        $('#popupboxSuccessVeecCreatePopup').modal({ backdrop: 'static', keyboard: false });
                        $('#popupboxSuccessVeecCreatePopup').find('#successVeecCreateMessage').text(data + " was successfully created.");
                        $('#popupboxSuccessVeecCreatePopup').find('#viewCreatedVeec').attr('veecID', response.veecId);
                        $('#createVEECPopup')[0].reset();
                    }
                    else {

                        $('#popupboxSuccessJobCreatePopup').find('#errorMsgRegionForCreateVEECPopUp').text(response.error);
                    }
                },
                error: function () {
                    ShowCreatedVEECErrorMessage("Veec has not been created.");
                }
            });
        }
    });
    
    $("#createVEEC_VEECOwnerDetail_OwnerType").change(function (e) {
        validateOrganisationVEEC('createVEEC_');
    });
    $("#createVEEC_VEECInstallationDetail_UnitTypeID").change(function () {
        addressValidationRules("createVEEC_VEECInstallationDetail")
    })
})
function SetVEECInstallationInfo() {

    VEECInstalltionInfo.push({
...
function DisplayVEECInstallationInfo() {

    $('#lblIndBusType').html($("#VEECInstallationDetail_IndustryBusinessType").val() > 0 ? $("#VEECInstallationDetail_IndustryBusinessType option:selected").text() : "");
    $('#lblNoOfLevels').html($('#VEECInstallationDetail_NumberOfLevels').val());
    $('#lblFloorSpace').html($('#VEECInstallationDetail_FloorSpace').val());
    $('#lblFloorSpaceArea').html($('#VEECInstallationDetail_FloorSpaceUpgradedArea').val());
    //$('#lblCertificateElectricalComplianceNumber').html($('#VEECInstallationDetail_CertificateElectricalComplianceNumber').val())
}
function AddressAutoComplete(town, state, postcode) {
    //$("#VEECOwnerDetail_Town").autocomplete({
    $(town).autocomplete({
        minLength: 3,
    ...
    //$("#VEECOwnerDetail_PostCode").autocomplete({
    $(postcode).autocomplete({
        ...
        select: function (event, ui) {
            $(state).val(ui.item.state);
            $(town).val(ui.item.location);
            $(state).valid();
            $(town).valid();
        }
    });
}
function validateFormVEEC() {
    validateOrganisationVEEC('createVEEC_');
    if ($("#createVEECPopup").valid()) {
        return true;
    }
...
function validateOrganisationVEEC(id) {

    if ($("#" + id + "VEECOwnerDetail_OwnerType").val() == 'Government body' || $("#" + id + "VEECOwnerDetail_OwnerType").val() == 'Corporate body' || $("#" + id + "VEECOwnerDetail_OwnerType").val() == 'Trustee') {
        $("#" + id + "VEECOwnerCompanyName").addClass("required");
        if ($("#" + id + "VEECOwnerDetail_CompanyName").val() != '') {
        } else {
            $("#" + id + "VEECOwnerDetail_CompanyName").removeClass('valid');
            $("#" + id + "VEECOwnerCompanyNameValidate").addClass("field-validation-error");
        }
        $("#" + id + "VEECOwnerCompanyNameValidate").show();
        $("#" + id + "VEECOwnerDetail_CompanyName").rules("add", {
            required: true,
            messages: {
        ...
        $("#" + id + "VEECOwnerDetail_CompanyName").rules('remove');
        $("#" + id + "VEECOwnerDetail_CompanyName").removeClass('input-validation-error');
        $("#" + id + "VEECOwnerCompanyName").removeClass("required");
        $("#" + id + "VEECOwnerCompanyNameValidate").hide();
    }
}
...
//        FillDropDown('ScoIDVEEC', urlGetSCOUser, BasicDetails_ScoID, true, null);
//    }
//    else {
