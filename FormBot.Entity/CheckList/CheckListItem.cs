...
namespace FormBot.Entity.CheckList
{
    public class CheckListItem
    {
        ...
        [DisplayName("Is None Field Map:")]
        public bool IsNoneFieldMap { get; set; }
        ...
        public string Id
        {
            get
            {
                return QueryString.QueryStringEncode("id=" + Convert.ToString(this.CheckListItemId));
            }
        }
        ...
        [DisplayName("CheckListPhotoType:")]
        [Required(ErrorMessage = "CheckListPhotoType is required.")]
        public int CheckListPhotoTypeId { get; set; }
        public bool AllowUploadPhotoFromGallary { get; set; }
        [DisplayName("Selfie Type:")]
        [Required(ErrorMessage = "Selfie type is required.")]
        public int? SelfieTypeId { get; set; }
    }
}
