...
namespace FormBot.Email
{
    ...
    public class Folder : IComparable
    {
        ...
        //Changed By Rajnikant Serasiya( Changed DefaultInboxSyncType from AllEntireMessages to DontSync)
        ...
        public Folder(long idFolder, int idAcct, long idParent, string name, string fullPath, FolderType type,
            FolderSyncType syncType, bool hide, short folderOrder)
            : this()
        {
            _id_folder = idFolder;
            _id_acct = idAcct;
        ...
        public Folder(MailBee.ImapMail.Folder fld, bool hide)
            : this()
        {
            _imapFolder = fld;
            _name = fld.ShortName;
