...
public class DateFormatting
{
    ...
    private static DateTime GetMessageDateWithOffset(DateTime msgDateReceivedOriginal, int timeOffsetInMinutes)
    {
        ...
        if (timeOffsetInMinutes != 0 && msgDate >= FormBot.Email.Constants.MinDateWithMaxZoneTimeOffset)
        {
...
public class AdminPanelUtils
{
    ...
    public static string GetWebMailDataFolder()
    {
        ...
        if (HttpContext.Current.Application[FormBot.Email.Constants.appSettingsDataFolderPath] != null)
        {
            strDataFolderPath = (string)HttpContext.Current.Application[FormBot.Email.Constants.appSettingsDataFolderPath];
        }
        else
        {
            strDataFolderPath = ConfigurationManager.AppSettings[FormBot.Email.Constants.appSettingsDataFolderPath];
        }
    ...
    public static string[] GetSupportedLangs(string dataFolderPath)
    {
        ...
        return (arr.Count > 0) ? (string[])arr.ToArray(typeof(string)) : new string[] { FormBot.Email.Constants.defaultLang };
    }
