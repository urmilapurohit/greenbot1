...
namespace FormBot.Email
{
    ...
    public class BaseWebMailActions
    {
        ...
        public BaseWebMailActions(Account acct)
        {
            _acct = acct;
            //_webPage = page;
        }
			...
			if (outputMsg.Attachments.Count > 0)
			{
				...
				else
				{
					//if (_webPage != null)
					{
                        ...
                        outputMsg.BodyHtmlText = outputMsg.GetHtmlAndSaveRelatedFiles(@"Email/ReadImageFile?filename=", VirtualMappingType.Static, MessageFolderBehavior.DoNotCreate);
