...
d(this).removeClass("ui-datepicker-next-hover")}).delegate("button, .ui-datepicker-prev, .ui-datepicker-next, .ui-datepicker-calendar td a","mouseover",S)}function S(){d.datepicker._isDisabledDatepicker(D.inline?D.dpDiv.parent()[0]:D.input[0])||(d(this).parents(".ui-datepicker-calendar").find("a").removeClass("ui-state-hover"),d(this).addClass("ui-state-hover"),-1!==this.className.indexOf("ui-datepicker-prev")&&d(this).addClass("ui-datepicker-prev-hover"),-1!==this.className.indexOf("ui-datepicker-next")&&
d(this).addClass("ui-datepicker-next-hover"))}function H(a,b){d.extend(a,b);for(var c in b)null==b[c]&&(a[c]=b[c]);return a}function I(a){return function(){var b=this.element.val();a.apply(this,arguments);this._refresh();b!==this.element.val()&&this._trigger("change")}}d.ui=d.ui||{};d.extend(d.ui,{version:"1.11.4",keyCode:{BACKSPACE:8,COMMA:188,DELETE:46,DOWN:40,END:35,ENTER:13,ESCAPE:27,HOME:36,LEFT:37,PAGE_DOWN:34,PAGE_UP:33,PERIOD:190,RIGHT:39,SPACE:32,TAB:9,UP:38}});d.fn.extend({scrollParent:function(a){var b=
...
e=this.widget());d.each(c,function(c,h){function g(){if(a||!0!==f.options.disabled&&!d(this).hasClass("ui-state-disabled"))return("string"===typeof h?f[h]:h).apply(f,arguments)}"string"!==typeof h&&(g.guid=h.guid=h.guid||g.guid||d.guid++);var m=c.match(/^([\w:-]*)\s*(.*)$/),l=m[1]+f.eventNamespace;(m=m[2])?e.delegate(m,l,g):b.bind(l,g)})},_off:function(a,b){b=(b||"").split(" ").join(this.eventNamespace+" ")+this.eventNamespace;a.unbind(b).undelegate(b);this.bindings=d(this.bindings.not(a).get());
...
hide:"fadeOut"},function(a,b){d.Widget.prototype["_"+a]=function(c,e,f){"string"===typeof e&&(e={effect:e});var g=e?!0===e||"number"===typeof e?b:e.effect||b:a;e=e||{};"number"===typeof e&&(e={duration:e});var h=!d.isEmptyObject(e);e.complete=f;e.delay&&c.delay(e.delay);if(h&&d.effects&&d.effects.effect[g])c[a](e);else if(g!==a&&c[g])c[g](e.duration,e.easing,f);else c.queue(function(b){d(this)[a]();f&&f.call(c[0]);b()})}});var J=!1;d(document).mouseup(function(){J=!1});d.widget("ui.mouse",{version:"1.11.4",
...
this.widgetName,this._mouseMoveDelegate).unbind("mouseup."+this.widgetName,this._mouseUpDelegate);this._mouseStarted&&(this._mouseStarted=!1,a.target===this._mouseDownEvent.target&&d.data(a.target,this.widgetName+".preventClickEvent",!0),this._mouseStop(a));return J=!1},_mouseDistanceMet:function(a){return Math.max(Math.abs(this._mouseDownEvent.pageX-a.pageX),Math.abs(this._mouseDownEvent.pageY-a.pageY))>=this.options.distance},_mouseDelayMet:function(){return this.mouseDelayMet},_mouseStart:function(){},
...
offset:a.offset()}}d.ui=d.ui||{};var c,e,f=Math.max,g=Math.abs,h=Math.round,k=/left|center|right/,m=/top|center|bottom/,l=/[\+\-]\d+(\.[\d]+)?%?/,n=/^\w+/,p=/%$/,q=d.fn.position;d.position={scrollbarWidth:function(){if(void 0!==c)return c;var a=d("<div style='display:block;position:absolute;width:50px;height:50px;overflow:hidden;'><div style='height:100px;width:auto;'></div></div>");var b=a.children()[0];d("body").append(a);var e=b.offsetWidth;a.css("overflow","scroll");b=b.offsetWidth;e===b&&(b=
...
isWindow:b,isDocument:c,offset:a.offset()||{left:0,top:0},scrollLeft:a.scrollLeft(),scrollTop:a.scrollTop(),width:b||c?a.width():a.outerWidth(),height:b||c?a.height():a.outerHeight()}}};d.fn.position=function(c){if(!c||!c.of)return q.apply(this,arguments);c=d.extend({},c);var t=d(c.of),v=d.position.getWithinInfo(c.within),w=d.position.getScrollInfo(v),x=(c.collision||"flip").split(" "),p={};var u=b(t);t[0].preventDefault&&(c.at="left top");var G=u.width;var C=u.height;var L=u.offset;var B=d.extend({},
L);d.each(["my","at"],function(){var a=(c[this]||"").split(" ");1===a.length&&(a=k.test(a[0])?a.concat(["center"]):m.test(a[0])?["center"].concat(a):["center","center"]);a[0]=k.test(a[0])?a[0]:"center";a[1]=m.test(a[1])?a[1]:"center";var b=l.exec(a[0]);var d=l.exec(a[1]);p[this]=[b?b[0]:0,d?d[0]:0];c[this]=[n.exec(a[0])[0],n.exec(a[1])[0]]});1===x.length&&(x[1]=x[0]);"right"===c.at[0]?B.left+=G:"center"===c.at[0]&&(B.left+=G/2);"bottom"===c.at[1]?B.top+=C:"center"===c.at[1]&&(B.top+=C/2);var K=a(p.at,
G,C);B.left+=K[0];B.top+=K[1];return this.each(function(){var b,k=d(this),m=k.outerWidth(),l=k.outerHeight(),n=parseInt(d.css(this,"marginLeft"),10)||0,u=parseInt(d.css(this,"marginTop"),10)||0,z=m+n+(parseInt(d.css(this,"marginRight"),10)||0)+w.width,q=l+u+(parseInt(d.css(this,"marginBottom"),10)||0)+w.height,r=d.extend({},B),M=a(p.my,k.outerWidth(),k.outerHeight());"right"===c.my[0]?r.left-=m:"center"===c.my[0]&&(r.left-=m/2);"bottom"===c.my[1]?r.top-=l:"center"===c.my[1]&&(r.top-=l/2);r.left+=
M[0];r.top+=M[1];e||(r.left=h(r.left),r.top=h(r.top));var D={marginLeft:n,marginTop:u};d.each(["left","top"],function(a,b){if(d.ui.position[x[a]])d.ui.position[x[a]][b](r,{targetWidth:G,targetHeight:C,elemWidth:m,elemHeight:l,collisionPosition:D,collisionWidth:z,collisionHeight:q,offset:[K[0]+M[0],K[1]+M[1]],my:c.my,at:c.at,within:v,elem:k})});c.using&&(b=function(a){var b=L.left-r.left,d=b+G-m,e=L.top-r.top,h=e+C-l,v={target:{element:t,left:L.left,top:L.top,width:G,height:C},element:{element:k,left:r.left,
top:r.top,width:m,height:l},horizontal:0>d?"left":0<b?"right":"center",vertical:0>h?"top":0<e?"bottom":"middle"};G<m&&g(b+d)<G&&(v.horizontal="center");C<l&&g(e+h)<C&&(v.vertical="middle");f(g(b),g(d))>f(g(e),g(h))?v.important="horizontal":v.important="vertical";c.using.call(this,a,v)});k.offset(d.extend(r,{using:b}))})};d.ui.position={fit:{left:function(a,b){var c=b.within,d=c.isWindow?c.scrollLeft:c.offset.left,e=c.width,g=a.left-b.collisionPosition.marginLeft;c=d-g;var h=g+b.collisionWidth-e-d;
...
flip:{left:function(a,b){var c=b.within,d=c.offset.left+c.scrollLeft,e=c.width,f=c.isWindow?c.scrollLeft:c.offset.left,h=a.left-b.collisionPosition.marginLeft;c=h-f;var k=h+b.collisionWidth-e-f;h="left"===b.my[0]?-b.elemWidth:"right"===b.my[0]?b.elemWidth:0;var m="left"===b.at[0]?b.targetWidth:"right"===b.at[0]?-b.targetWidth:0,t=-2*b.offset[0];if(0>c){if(d=a.left+h+m+t+b.collisionWidth-e-d,0>d||d<g(c))a.left+=h+m+t}else 0<k&&(d=a.left-b.collisionPosition.marginLeft+h+m+t-f,0<d||g(d)<k)&&(a.left+=
h+m+t)},top:function(a,b){var c=b.within,d=c.offset.top+c.scrollTop,e=c.height,f=c.isWindow?c.scrollTop:c.offset.top,h=a.top-b.collisionPosition.marginTop;c=h-f;var k=h+b.collisionHeight-e-f;h="top"===b.my[1]?-b.elemHeight:"bottom"===b.my[1]?b.elemHeight:0;var m="top"===b.at[1]?b.targetHeight:"bottom"===b.at[1]?-b.targetHeight:0,l=-2*b.offset[1];if(0>c){if(d=a.top+h+m+l+b.collisionHeight-e-d,0>d||d<g(c))a.top+=h+m+l}else 0<k&&(d=a.top-b.collisionPosition.marginTop+h+m+l-f,0<d||g(d)<k)&&(a.top+=h+
m+l)}},flipfit:{left:function(){d.ui.position.flip.left.apply(this,arguments);d.ui.position.fit.left.apply(this,arguments)},top:function(){d.ui.position.flip.top.apply(this,arguments);d.ui.position.fit.top.apply(this,arguments)}}};(function(){var a,b=document.getElementsByTagName("body")[0];var c=document.createElement("div");var f=document.createElement(b?"div":"body");var g={visibility:"hidden",width:0,height:0,border:0,margin:0,background:"none"};b&&d.extend(g,{position:"absolute",left:"-1000px",
...
d("body").append(this._dialogInput),a=this._dialogInst=this._newInst(this._dialogInput,!1),a.settings={},d.data(this._dialogInput[0],"datepicker",a));H(a.settings,e||{});b=b&&b.constructor===Date?this._formatDate(a,b):b;this._dialogInput.val(b);this._pos=f?f.length?f:[f.pageX,f.pageY]:null;if(!this._pos){b=document.documentElement.clientWidth;e=document.documentElement.clientHeight;f=document.documentElement.scrollLeft||document.body.scrollLeft;var g=document.documentElement.scrollTop||document.body.scrollTop;
...
d.datepicker._curInst!==b&&(d.datepicker._curInst.dpDiv.stop(!0,!0),b&&d.datepicker._datepickerShowing&&d.datepicker._hideDatepicker(d.datepicker._curInst.input[0]));var c=(c=d.datepicker._get(b,"beforeShow"))?c.apply(a,[a,b]):{};if(!1!==c){H(b.settings,c);b.lastVal=null;d.datepicker._lastInput=a;d.datepicker._setDateFromField(b);d.datepicker._inDialog&&(a.value="");d.datepicker._pos||(d.datepicker._pos=d.datepicker._findPos(a),d.datepicker._pos[1]+=a.offsetHeight);var e=!1;d(a).parents().each(function(){e|=
...
X(d(a))+1);d.datepicker._datepickerShowing=!0;if(d.effects&&d.effects.effect[c])b.dpDiv.show(c,d.datepicker._get(b,"showOptions"),f);else b.dpDiv[c||"show"](c?f:null);d.datepicker._shouldFocusInput(b)&&b.input.focus();d.datepicker._curInst=b}}}},_updateDatepicker:function(a){this.maxRows=4;D=a;a.dpDiv.empty().append(this._generateHTML(a));this._attachHandlers(a);var b=this._getNumberOfMonths(a),c=b[1],e=a.dpDiv.find("."+this._dayOverClass+" a");0<e.length&&S.apply(e.get(0));a.dpDiv.removeClass("ui-datepicker-multi-2 ui-datepicker-multi-3 ui-datepicker-multi-4").width("");
...
null)||this._defaults.dayNames,m=(c?c.monthNamesShort:null)||this._defaults.monthNamesShort,l=(c?c.monthNames:null)||this._defaults.monthNames,n=c=-1,p=-1,q=-1,u=!1,t=function(b){(b=e+1<a.length&&a.charAt(e+1)===b)&&e++;return b},v=function(a){var c=t(a);c="@"===a?14:"!"===a?20:"y"===a&&c?4:"o"===a?3:2;a=new RegExp("^\\d{"+("y"===a?c:1)+","+c+"}");a=b.substring(f).match(a);if(!a)throw"Missing number at position "+f;f+=a[0].length;return parseInt(a[0],10)},w=function(a,c,e){var g=-1;a=d.map(t(a)?e:
c,function(a,b){return[[b,a]]}).sort(function(a,b){return-(a[1].length-b[1].length)});d.each(a,function(a,c){var d=c[1];if(b.substr(f,d.length).toLowerCase()===d.toLowerCase())return g=c[0],f+=d.length,!1});if(-1!==g)return g+1;throw"Unknown name at position "+f;},x=function(){if(b.charAt(f)!==a.charAt(e))throw"Unexpected literal at position "+f;f++};for(e=0;e<a.length;e++)if(u)"'"!==a.charAt(e)||t("'")?x():u=!1;else switch(a.charAt(e)){case "d":p=v("d");break;case "D":w("D",h,k);break;case "o":q=
v("o");break;case "m":n=v("m");break;case "M":n=w("M",m,l);break;case "y":c=v("y");break;case "@":var r=new Date(v("@"));c=r.getFullYear();n=r.getMonth()+1;p=r.getDate();break;case "!":r=new Date((v("!")-this._ticksTo1970)/1E4);c=r.getFullYear();n=r.getMonth()+1;p=r.getDate();break;case "'":t("'")?x():u=!0;break;default:x()}if(f<b.length&&(h=b.substr(f),!/^\s+/.test(h)))throw"Extra/unparsed characters found in date: "+h;-1===c?c=(new Date).getFullYear():100>c&&(c+=(new Date).getFullYear()-(new Date).getFullYear()%
...
Math.floor(4.925)),formatDate:function(a,b,c){if(!b)return"";var d,f=(c?c.dayNamesShort:null)||this._defaults.dayNamesShort,g=(c?c.dayNames:null)||this._defaults.dayNames,h=(c?c.monthNamesShort:null)||this._defaults.monthNamesShort;c=(c?c.monthNames:null)||this._defaults.monthNames;var k=function(b){(b=d+1<a.length&&a.charAt(d+1)===b)&&d++;return b},m=function(a,b,c){b=""+b;if(k(a))for(;b.length<c;)b="0"+b;return b},l=function(a,b,c,d){return k(a)?d[b]:c[b]},n="",p=!1;if(b)for(d=0;d<a.length;d++)if(p)"'"!==
a.charAt(d)||k("'")?n+=a.charAt(d):p=!1;else switch(a.charAt(d)){case "d":n+=m("d",b.getDate(),2);break;case "D":n+=l("D",b.getDay(),f,g);break;case "o":n+=m("o",Math.round(((new Date(b.getFullYear(),b.getMonth(),b.getDate())).getTime()-(new Date(b.getFullYear(),0,0)).getTime())/864E5),3);break;case "m":n+=m("m",b.getMonth()+1,2);break;case "M":n+=l("M",b.getMonth(),h,c);break;case "y":n+=k("y")?b.getFullYear():(10>b.getYear()%100?"0":"")+b.getYear()%100;break;case "@":n+=b.getTime();break;case "!":n+=
...
d,f,g=new Date;g=this._daylightSavingAdjust(new Date(g.getFullYear(),g.getMonth(),g.getDate()));var h=this._get(a,"isRTL");var k=this._get(a,"showButtonPanel");var m=this._get(a,"hideIfNoPrevNext");var l=this._get(a,"navigationAsDateFormat");var n=this._getNumberOfMonths(a),p=this._get(a,"showCurrentAtPos");var q=this._get(a,"stepMonths");var u=1!==n[0]||1!==n[1],t=this._daylightSavingAdjust(a.currentDay?new Date(a.currentYear,a.currentMonth,a.currentDay):new Date(9999,9,9)),v=this._getMinMaxDate(a,
"min"),w=this._getMinMaxDate(a,"max");p=a.drawMonth-p;var x=a.drawYear;0>p&&(p+=12,x--);if(w){var r=this._daylightSavingAdjust(new Date(w.getFullYear(),w.getMonth()-n[0]*n[1]+1,w.getDate()));for(r=v&&r<v?v:r;this._daylightSavingAdjust(new Date(x,p,1))>r;)p--,0>p&&(p=11,x--)}a.drawMonth=p;a.drawYear=x;r=this._get(a,"prevText");r=l?this.formatDate(r,this._daylightSavingAdjust(new Date(x,p-q,1)),this._getFormatConfig(a)):r;r=this._canAdjustMonth(a,-1,x,p)?"<a class='ui-datepicker-prev ui-corner-all' data-handler='prev' data-event='click' title='"+
r+"'><span class='ui-icon ui-icon-circle-triangle-"+(h?"e":"w")+"'>"+r+"</span></a>":m?"":"<a class='ui-datepicker-prev ui-corner-all ui-state-disabled' title='"+r+"'><span class='ui-icon ui-icon-circle-triangle-"+(h?"e":"w")+"'>"+r+"</span></a>";var z=this._get(a,"nextText");z=l?this.formatDate(z,this._daylightSavingAdjust(new Date(x,p+q,1)),this._getFormatConfig(a)):z;m=this._canAdjustMonth(a,1,x,p)?"<a class='ui-datepicker-next ui-corner-all' data-handler='next' data-event='click' title='"+z+"'><span class='ui-icon ui-icon-circle-triangle-"+
(h?"w":"e")+"'>"+z+"</span></a>":m?"":"<a class='ui-datepicker-next ui-corner-all ui-state-disabled' title='"+z+"'><span class='ui-icon ui-icon-circle-triangle-"+(h?"w":"e")+"'>"+z+"</span></a>";q=this._get(a,"currentText");z=this._get(a,"gotoCurrent")&&a.currentDay?t:g;q=l?this.formatDate(q,z,this._getFormatConfig(a)):q;l=a.inline?"":"<button type='button' class='ui-datepicker-close ui-state-default ui-priority-primary ui-corner-all' data-handler='hide' data-event='click'>"+this._get(a,"closeText")+
"</button>";k=k?"<div class='ui-datepicker-buttonpane ui-widget-content'>"+(h?l:"")+(this._isInRange(a,z)?"<button type='button' class='ui-datepicker-current ui-state-default ui-priority-secondary ui-corner-all' data-handler='today' data-event='click'>"+q+"</button>":"")+(h?"":l)+"</div>":"";l=parseInt(this._get(a,"firstDay"),10);l=isNaN(l)?0:l;q=this._get(a,"showWeek");z=this._get(a,"dayNames");var G=this._get(a,"dayNamesMin");var C=this._get(a,"monthNames");var L=this._get(a,"monthNamesShort");
var B=this._get(a,"beforeShowDay");var K=this._get(a,"showOtherMonths");var Z=this._get(a,"selectOtherMonths");var U=this._getDefaultDate(a);var V="";A;for(b=0;b<n[0];b++){var D="";this.maxRows=4;for(c=0;c<n[1];c++){var I=this._daylightSavingAdjust(new Date(x,p,a.selectedDay));var A=" ui-corner-all";var E="";if(u){E+="<div class='ui-datepicker-group";if(1<n[1])switch(c){case 0:E+=" ui-datepicker-group-first";A=" ui-corner-"+(h?"right":"left");break;case n[1]-1:E+=" ui-datepicker-group-last";A=" ui-corner-"+
(h?"left":"right");break;default:E+=" ui-datepicker-group-middle",A=""}E+="'>"}E+="<div class='ui-datepicker-header ui-widget-header ui-helper-clearfix"+A+"'>"+(/all|left/.test(A)&&0===b?h?m:r:"")+(/all|right/.test(A)&&0===b?h?r:m:"")+this._generateMonthYearHeader(a,p,x,v,w,0<b||0<c,C,L)+"</div><table class='ui-datepicker-calendar'><thead><tr>";var F=q?"<th class='ui-datepicker-week-col'>"+this._get(a,"weekHeader")+"</th>":"";for(A=0;7>A;A++){var y=(A+l)%7;F+="<th scope='col'"+(5<=(A+l+6)%7?" class='ui-datepicker-week-end'":
"")+"><span title='"+z[y]+"'>"+G[y]+"</span></th>"}E+=F+"</tr></thead><tbody>";F=this._getDaysInMonth(x,p);x===a.selectedYear&&p===a.selectedMonth&&(a.selectedDay=Math.min(a.selectedDay,F));A=(this._getFirstDayOfMonth(x,p)-l+7)%7;F=Math.ceil((A+F)/7);this.maxRows=F=u?this.maxRows>F?this.maxRows:F:F;y=this._daylightSavingAdjust(new Date(x,p,1-A));for(d=0;d<F;d++){E+="<tr>";var M=q?"<td class='ui-datepicker-week-col'>"+this._get(a,"calculateWeek")(y)+"</td>":"";for(A=0;7>A;A++){var H=B?B.apply(a.input?
a.input[0]:null,[y]):[!0,""];var J=(f=y.getMonth()!==p)&&!Z||!H[0]||v&&y<v||w&&y>w;M+="<td class='"+(5<=(A+l+6)%7?" ui-datepicker-week-end":"")+(f?" ui-datepicker-other-month":"")+(y.getTime()===I.getTime()&&p===a.selectedMonth&&a._keyEvent||U.getTime()===y.getTime()&&U.getTime()===I.getTime()?" "+this._dayOverClass:"")+(J?" "+this._unselectableClass+" ui-state-disabled":"")+(f&&!K?"":" "+H[1]+(y.getTime()===t.getTime()?" "+this._currentClass:"")+(y.getTime()===g.getTime()?" ui-datepicker-today":
""))+"'"+(f&&!K||!H[2]?"":" title='"+H[2].replace(/'/g,"&#39;")+"'")+(J?"":" data-handler='selectDay' data-event='click' data-month='"+y.getMonth()+"' data-year='"+y.getFullYear()+"'")+">"+(f&&!K?"&#xa0;":J?"<span class='ui-state-default'>"+y.getDate()+"</span>":"<a class='ui-state-default"+(y.getTime()===g.getTime()?" ui-state-highlight":"")+(y.getTime()===t.getTime()?" ui-state-active":"")+(f?" ui-priority-secondary":"")+"' href='#'>"+y.getDate()+"</a>")+"</td>";y.setDate(y.getDate()+1);y=this._daylightSavingAdjust(y)}E+=
M+"</tr>"}p++;11<p&&(p=0,x++);E+="</tbody></table>"+(u?"</div>"+(0<n[0]&&c===n[1]-1?"<div class='ui-datepicker-row-break'></div>":""):"");D+=E}V+=D}a._keyEvent=!1;return V+k},_generateMonthYearHeader:function(a,b,c,d,f,g,h,k){var e,l=this._get(a,"changeMonth"),n=this._get(a,"changeYear"),p=this._get(a,"showMonthAfterYear"),q="<div class='ui-datepicker-title'>",u="";if(g||!l)u+="<span class='ui-datepicker-month'>"+h[b]+"</span>";else{h=d&&d.getFullYear()===c;var t=f&&f.getFullYear()===c;u+="<select class='ui-datepicker-month' data-handler='selectMonth' data-event='change'>";
for(e=0;12>e;e++)(!h||e>=d.getMonth())&&(!t||e<=f.getMonth())&&(u+="<option value='"+e+"'"+(e===b?" selected='selected'":"")+">"+k[e]+"</option>");u+="</select>"}p||(q+=u+(!g&&l&&n?"":"&#xa0;"));if(!a.yearshtml)if(a.yearshtml="",g||!n)q+="<span class='ui-datepicker-year'>"+c+"</span>";else{k=this._get(a,"yearRange").split(":");var v=(new Date).getFullYear();h=function(a){a=a.match(/c[+\-].*/)?c+parseInt(a.substring(1),10):a.match(/[+\-].*/)?v+parseInt(a,10):parseInt(a,10);return isNaN(a)?v:a};b=h(k[0]);
k=Math.max(b,h(k[1]||""));b=d?Math.max(b,d.getFullYear()):b;k=f?Math.min(k,f.getFullYear()):k;for(a.yearshtml+="<select class='ui-datepicker-year' data-handler='selectYear' data-event='change'>";b<=k;b++)a.yearshtml+="<option value='"+b+"'"+(b===c?" selected='selected'":"")+">"+b+"</option>";a.yearshtml+="</select>";q+=a.yearshtml;a.yearshtml=null}q+=this._get(a,"yearSuffix");p&&(q+=(!g&&l&&n?"":"&#xa0;")+u);return q+"</div>"},_adjustInstDate:function(a,b,c){var d=a.drawYear+("Y"===c?b:0),f=a.drawMonth+
...
a||"getDate"===a||"widget"===a)||"option"===a&&2===arguments.length&&"string"===typeof arguments[1]?d.datepicker["_"+a+"Datepicker"].apply(d.datepicker,[this[0]].concat(b)):this.each(function(){"string"===typeof a?d.datepicker["_"+a+"Datepicker"].apply(d.datepicker,[this].concat(b)):d.datepicker._attachDatepicker(this,a)})};d.datepicker=new Q;d.datepicker.initialized=!1;d.datepicker.uuid=(new Date).getTime();d.datepicker.version="1.11.4";d.widget("ui.draggable",d.ui.mouse,{version:"1.11.4",widgetEventPrefix:"drag",
...
d(this),b=a.offset();this!==c.element[0]&&c.snapElements.push({item:this,width:a.outerWidth(),height:a.outerHeight(),top:b.top,left:b.left})})},drag:function(a,b,c){var e,f=c.options,g=f.snapTolerance,h=b.offset.left,k=h+c.helperProportions.width,m=b.offset.top,l=m+c.helperProportions.height;for(e=c.snapElements.length-1;0<=e;e--){var n=c.snapElements[e].left-c.margins.left;var p=n+c.snapElements[e].width;var q=c.snapElements[e].top-c.margins.top;var u=q+c.snapElements[e].height;if(k<n-g||h>p+g||
l<q-g||m>u+g||!d.contains(c.snapElements[e].item.ownerDocument,c.snapElements[e].item))c.snapElements[e].snapping&&c.options.snap.release&&c.options.snap.release.call(c.element,a,d.extend(c._uiHash(),{snapItem:c.snapElements[e].item})),c.snapElements[e].snapping=!1;else{if("inner"!==f.snapMode){var t=Math.abs(q-l)<=g;var v=Math.abs(u-m)<=g;var w=Math.abs(n-k)<=g;var x=Math.abs(p-h)<=g;t&&(b.position.top=c._convertPositionTo("relative",{top:q-c.helperProportions.height,left:0}).top);v&&(b.position.top=
c._convertPositionTo("relative",{top:u,left:0}).top);w&&(b.position.left=c._convertPositionTo("relative",{top:0,left:n-c.helperProportions.width}).left);x&&(b.position.left=c._convertPositionTo("relative",{top:0,left:p}).left)}var r=t||v||w||x;"outer"!==f.snapMode&&(t=Math.abs(q-m)<=g,v=Math.abs(u-l)<=g,w=Math.abs(n-h)<=g,x=Math.abs(p-k)<=g,t&&(b.position.top=c._convertPositionTo("relative",{top:q,left:0}).top),v&&(b.position.top=c._convertPositionTo("relative",{top:u-c.helperProportions.height,left:0}).top),
w&&(b.position.left=c._convertPositionTo("relative",{top:0,left:n}).left),x&&(b.position.left=c._convertPositionTo("relative",{top:0,left:p-c.helperProportions.width}).left));!c.snapElements[e].snapping&&(t||v||w||x||r)&&c.options.snap.snap&&c.options.snap.snap.call(c.element,a,d.extend(c._uiHash(),{snapItem:c.snapElements[e].item}));c.snapElements[e].snapping=t||v||w||x||r}}}});d.ui.plugin.add("draggable","stack",{start:function(a,b,c){a=d.makeArray(d(c.options.stack)).sort(function(a,b){return(parseInt(d(a).css("zIndex"),
...
stop:function(){var a=d(this).resizable("instance");a.ghost&&a.helper&&a.helper.get(0).removeChild(a.ghost.get(0))}});d.ui.plugin.add("resizable","grid",{resize:function(){var a=d(this).resizable("instance"),b=a.options,c=a.size,e=a.originalSize,f=a.originalPosition,g=a.axis,h="number"===typeof b.grid?[b.grid,b.grid]:b.grid,k=h[0]||1,m=h[1]||1,l=Math.round((c.width-e.width)/k)*k;c=Math.round((c.height-e.height)/m)*m;var n=e.width+l,p=e.height+c,q=b.maxWidth&&b.maxWidth<n,u=b.maxHeight&&b.maxHeight<
p,t=b.minWidth&&b.minWidth>n,v=b.minHeight&&b.minHeight>p;b.grid=h;t&&(n+=k);v&&(p+=m);q&&(n-=k);u&&(p-=m);if(/^(se|s|e)$/.test(g))a.size.width=n,a.size.height=p;else if(/^(ne)$/.test(g))a.size.width=n,a.size.height=p,a.position.top=f.top-c;else if(/^(sw)$/.test(g))a.size.width=n,a.size.height=p,a.position.left=f.left-l;else{if(0>=p-m||0>=n-k)var w=a._getPaddingPlusBorderDimensions(this);0<p-m?(a.size.height=p,a.position.top=f.top-c):(p=m-w.height,a.size.height=p,a.position.top=f.top+e.height-p);
0<n-k?(a.size.width=n,a.position.left=f.left-l):(n=k-w.width,a.size.width=n,a.position.left=f.left+e.width-n)}}});d.widget("ui.dialog",{version:"1.11.4",options:{appendTo:"body",autoOpen:!0,buttons:[],closeOnEscape:!0,closeText:"Close",dialogClass:"",draggable:!0,hide:null,height:"auto",maxHeight:null,maxWidth:null,minHeight:150,minWidth:150,modal:!1,position:{my:"center",at:"center",of:window,collision:"fit",using:function(a){var b=d(this).css(a).offset().top;0>b&&d(this).css("top",a.top-b)}},resizable:!0,
...
"_"+a;b.props.alpha={idx:3,type:"percent",def:1}});k.fn=a.extend(k.prototype,{parse:function(e,f,g,h){if(e===b)return this._rgba=[null,null,null,null],this;if(e.jquery||e.nodeType)e=a(e).css(f),f=b;var l=this,n=a.type(e),p=this._rgba=[];f!==b&&(e=[e,f,g,h],n="array");if("string"===n)return this.parse(d(e)||u._default);if("array"===n)return q(m.rgba.props,function(a,b){p[b.idx]=c(e[b.idx],b)}),this;if("object"===n)return e instanceof k?q(m,function(a,b){e[b.cache]&&(l[b.cache]=e[b.cache].slice())}):
...
d){b[d.cache]&&a.push(c)});return a.pop()},transition:function(a,b){var d=k(a),e=d._space(),f=m[e],g=0===this.alpha()?k("transparent"):this,h=g[f.cache]||f.to(g._rgba),n=h.slice();d=d[f.cache];q(f.props,function(a,e){var f=e.idx,g=h[f],k=d[f],m=l[e.type]||{};null!==k&&(null===g?n[f]=k:(m.mod&&(k-g>m.mod/2?g+=m.mod:g-k>m.mod/2&&(g-=m.mod)),n[f]=c((k-g)*b+g,e)))});return this[e](n)},blend:function(b){if(1===this._rgba[3])return this;var c=this._rgba.slice(),d=c.pop(),e=k(b)._rgba;return k(a.map(c,function(a,
...
c(1-a)};d.easing["easeInOut"+a]=function(a){return.5>a?c(2*a)/2:1-c(-2*a+2)/2}})})();d.effects.effect.blind=function(a,b){var c=d(this),e="position top bottom left right height width".split(" "),f=d.effects.setMode(c,a.mode||"hide"),g=a.direction||"up",h=/up|down|vertical/.test(g),k=h?"height":"width",m=h?"top":"left";g=/up|left|vertical|horizontal/.test(g);var l={},n="show"===f;c.parent().is(".ui-effects-wrapper")?d.effects.save(c.parent(),e):d.effects.save(c,e);c.show();var p=d.effects.createWrapper(c).css({overflow:"hidden"});
var q=p[k]();var u=parseFloat(p.css(m))||0;l[k]=n?q:0;g||(c.css(h?"bottom":"right",0).css(h?"top":"left","auto").css({position:"absolute"}),l[m]=n?u:q+u);n&&(p.css(k,0),g||p.css(m,u+q));p.animate(l,{duration:a.duration,easing:a.easing,queue:!1,complete:function(){"hide"===f&&c.hide();d.effects.restore(c,e);d.effects.removeWrapper(c);b()}})};d.effects.effect.bounce=function(a,b){var c=d(this),e="position top bottom left right height width".split(" "),f=d.effects.setMode(c,a.mode||"effect"),g="hide"===
f,h="show"===f,k=a.direction||"up";f=a.distance;var m=a.times||5,l=2*m+(h||g?1:0),n=a.duration/l,p=a.easing,q="up"===k||"down"===k?"top":"left";k="up"===k||"left"===k;var u=c.queue(),t=u.length;(h||g)&&e.push("opacity");d.effects.save(c,e);c.show();d.effects.createWrapper(c);f||(f=c["top"===q?"outerHeight":"outerWidth"]()/3);if(h){var v={opacity:1};v[q]=0;c.css("opacity",0).css(q,k?2*-f:2*f).animate(v,n,p)}g&&(f/=Math.pow(2,m-1));v={};for(h=v[q]=0;h<m;h++){var w={};w[q]=(k?"-=":"+=")+f;c.animate(w,
n,p).animate(v,n,p);f=g?2*f:f/2}g&&(w={opacity:0},w[q]=(k?"-=":"+=")+f,c.animate(w,n,p));c.queue(function(){g&&c.hide();d.effects.restore(c,e);d.effects.removeWrapper(c);b()});1<t&&u.splice.apply(u,[1,0].concat(u.splice(t,l+1)));c.dequeue()};d.effects.effect.clip=function(a,b){var c=d(this),e="position top bottom left right height width".split(" "),f="show"===d.effects.setMode(c,a.mode||"hide"),g="vertical"===(a.direction||"vertical"),h=g?"height":"width";g=g?"top":"left";var k={};d.effects.save(c,
e);c.show();var m=d.effects.createWrapper(c).css({overflow:"hidden"});m="IMG"===c[0].tagName?m:c;var l=m[h]();f&&(m.css(h,0),m.css(g,l/2));k[h]=f?l:0;k[g]=f?0:l/2;m.animate(k,{queue:!1,duration:a.duration,easing:a.easing,complete:function(){f||c.hide();d.effects.restore(c,e);d.effects.removeWrapper(c);b()}})};d.effects.effect.drop=function(a,b){var c=d(this),e="position top bottom left right opacity height width".split(" "),f=d.effects.setMode(c,a.mode||"hide"),g="show"===f,h=a.direction||"left",
k="up"===h||"down"===h?"top":"left";h="up"===h||"left"===h?"pos":"neg";var m={opacity:g?1:0};d.effects.save(c,e);c.show();d.effects.createWrapper(c);var l=a.distance||c["top"===k?"outerHeight":"outerWidth"](!0)/2;g&&c.css("opacity",0).css(k,"pos"===h?-l:l);m[k]=(g?"pos"===h?"+=":"-=":"pos"===h?"-=":"+=")+l;c.animate(m,{queue:!1,duration:a.duration,easing:a.easing,complete:function(){"hide"===f&&c.hide();d.effects.restore(c,e);d.effects.removeWrapper(c);b()}})};d.effects.effect.explode=function(a,
b){function c(){n.push(this);n.length===e*f&&(g.css({visibility:"visible"}),d(n).remove(),h||g.hide(),b())}var e=a.pieces?Math.round(Math.sqrt(a.pieces)):3,f=e,g=d(this),h="show"===d.effects.setMode(g,a.mode||"hide"),k=g.show().css("visibility","hidden").offset(),m=Math.ceil(g.outerWidth()/f),l=Math.ceil(g.outerHeight()/e),n=[],p,q;for(p=0;p<e;p++){var u=k.top+p*l;var t=p-(e-1)/2;for(q=0;q<f;q++){var v=k.left+q*m;var w=q-(f-1)/2;g.clone().appendTo("body").wrap("<div></div>").css({position:"absolute",
visibility:"visible",left:-q*m,top:-p*l}).parent().addClass("ui-effects-explode").css({position:"absolute",overflow:"hidden",width:m,height:l,left:v+(h?w*m:0),top:u+(h?t*l:0),opacity:h?0:1}).animate({left:v+(h?0:w*m),top:u+(h?0:t*l),opacity:h?1:0},a.duration||500,a.easing,c)}}};d.effects.effect.fade=function(a,b){var c=d(this),e=d.effects.setMode(c,a.mode||"toggle");c.animate({opacity:e},{queue:!1,duration:a.duration,easing:a.easing,complete:b})};d.effects.effect.fold=function(a,b){var c=d(this),
e="position top bottom left right height width".split(" "),f=d.effects.setMode(c,a.mode||"hide"),g="show"===f,h="hide"===f;f=a.size||15;var k=/([0-9]+)%/.exec(f),m=!!a.horizFirst,l=g!==m,n=l?["width","height"]:["height","width"],p=a.duration/2,q={},u={};d.effects.save(c,e);c.show();var t=d.effects.createWrapper(c).css({overflow:"hidden"});l=l?[t.width(),t.height()]:[t.height(),t.width()];k&&(f=parseInt(k[1],10)/100*l[h?0:1]);g&&t.css(m?{height:0,width:f}:{height:f,width:0});q[n[0]]=g?l[0]:f;u[n[1]]=
g?l[1]:0;t.animate(q,p,a.easing).animate(u,p,a.easing,function(){h&&c.hide();d.effects.restore(c,e);d.effects.removeWrapper(c);b()})};d.effects.effect.highlight=function(a,b){var c=d(this),e=["backgroundImage","backgroundColor","opacity"],f=d.effects.setMode(c,a.mode||"show"),g={backgroundColor:c.css("backgroundColor")};"hide"===f&&(g.opacity=0);d.effects.save(c,e);c.show().css({backgroundImage:"none",backgroundColor:a.color||"#ffff99"}).animate(g,{queue:!1,duration:a.duration,easing:a.easing,complete:function(){"hide"===
...
"both";var q=a.origin||["middle","center"];var u=c.css("position"),t=n?e:f,v={height:0,width:0,outerHeight:0,outerWidth:0};"show"===l&&c.show();f={height:c.height(),width:c.width(),outerHeight:c.outerHeight(),outerWidth:c.outerWidth()};"toggle"===a.mode&&"show"===l?(c.from=a.to||v,c.to=a.from||f):(c.from=a.from||("show"===l?v:f),c.to=a.to||("hide"===l?v:f));var w=c.from.height/f.height;var x=c.from.width/f.width;var r=c.to.height/f.height;var z=c.to.width/f.width;if("box"===p||"both"===p)w!==r&&(t=
t.concat(k),c.from=d.effects.setTransition(c,k,w,c.from),c.to=d.effects.setTransition(c,k,r,c.to)),x!==z&&(t=t.concat(m),c.from=d.effects.setTransition(c,m,x,c.from),c.to=d.effects.setTransition(c,m,z,c.to));"content"!==p&&"both"!==p||w===r||(t=t.concat(h).concat(g),c.from=d.effects.setTransition(c,h,w,c.from),c.to=d.effects.setTransition(c,h,r,c.to));d.effects.save(c,t);c.show();d.effects.createWrapper(c);c.css("overflow","hidden").css(c.from);q&&(q=d.effects.getBaseline(q,f),c.from.top=(f.outerHeight-
c.outerHeight())*q.y,c.from.left=(f.outerWidth-c.outerWidth())*q.x,c.to.top=(f.outerHeight-c.to.outerHeight)*q.y,c.to.left=(f.outerWidth-c.to.outerWidth)*q.x);c.css(c.from);if("content"===p||"both"===p)k=k.concat(["marginTop","marginBottom"]).concat(h),m=m.concat(["marginLeft","marginRight"]),g=e.concat(k).concat(m),c.find("*[width]").each(function(){var b=d(this),c=b.height(),e=b.width(),f=b.outerHeight(),h=b.outerWidth();n&&d.effects.save(b,g);b.from={height:c*w,width:e*x,outerHeight:f*w,outerWidth:h*
x};b.to={height:c*r,width:e*z,outerHeight:c*r,outerWidth:e*z};w!==r&&(b.from=d.effects.setTransition(b,k,w,b.from),b.to=d.effects.setTransition(b,k,r,b.to));x!==z&&(b.from=d.effects.setTransition(b,m,x,b.from),b.to=d.effects.setTransition(b,m,z,b.to));b.css(b.from);b.animate(b.to,a.duration,a.easing,function(){n&&d.effects.restore(b,g)})});c.animate(c.to,{queue:!1,duration:a.duration,easing:a.easing,complete:function(){0===c.to.opacity&&c.css("opacity",c.from.opacity);"hide"===l&&c.hide();d.effects.restore(c,
t);n||("static"===u?c.css({position:"relative",top:c.to.top,left:c.to.left}):d.each(["top","left"],function(a,b){c.css(b,function(b,d){var e=parseInt(d,10),f=a?c.to.left:c.to.top;return"auto"===d?f+"px":e+f+"px"})}));d.effects.removeWrapper(c);b()}})};d.effects.effect.scale=function(a,b){var c=d(this),e=d.extend(!0,{},a),f=d.effects.setMode(c,a.mode||"effect"),g=parseInt(a.percent,10)||(0===parseInt(a.percent,10)?0:"hide"===f?0:100),h=a.direction||"both",k=a.origin,m={height:c.height(),width:c.width(),
outerHeight:c.outerHeight(),outerWidth:c.outerWidth()},l="horizontal"!==h?g/100:1;g="vertical"!==h?g/100:1;e.effect="size";e.queue=!1;e.complete=b;"effect"!==f&&(e.origin=k||["middle","center"],e.restore=!0);e.from=a.from||("show"===f?{height:0,width:0,outerHeight:0,outerWidth:0}:m);e.to={height:m.height*l,width:m.width*g,outerHeight:m.outerHeight*l,outerWidth:m.outerWidth*g};e.fade&&("show"===f&&(e.from.opacity=0,e.to.opacity=1),"hide"===f&&(e.from.opacity=1,e.to.opacity=0));c.effect(e)};d.effects.effect.puff=
...
e,g="hide"===e;e=2*(a.times||5)+(f||"hide"===e?1:0);var h=a.duration/e,k=0,m=c.queue(),l=m.length;if(f||!c.is(":visible"))c.css("opacity",0).show(),k=1;for(f=1;f<e;f++)c.animate({opacity:k},h,a.easing),k=1-k;c.animate({opacity:k},h,a.easing);c.queue(function(){g&&c.hide();b()});1<l&&m.splice.apply(m,[1,0].concat(m.splice(l,e+1)));c.dequeue()};d.effects.effect.shake=function(a,b){var c=d(this),e="position top bottom left right height width".split(" "),f=d.effects.setMode(c,a.mode||"effect"),g=a.direction||
"left",h=a.distance||20,k=a.times||3,m=2*k+1,l=Math.round(a.duration/m),n="up"===g||"down"===g?"top":"left",p="up"===g||"left"===g;g={};var q={},u={},t=c.queue(),v=t.length;d.effects.save(c,e);c.show();d.effects.createWrapper(c);g[n]=(p?"-=":"+=")+h;q[n]=(p?"+=":"-=")+2*h;u[n]=(p?"-=":"+=")+2*h;c.animate(g,l,a.easing);for(h=1;h<k;h++)c.animate(q,l,a.easing).animate(u,l,a.easing);c.animate(q,l,a.easing).animate(g,l/2,a.easing).queue(function(){"hide"===f&&c.hide();d.effects.restore(c,e);d.effects.removeWrapper(c);
b()});1<v&&t.splice.apply(t,[1,0].concat(t.splice(v,m+1)));c.dequeue()};d.effects.effect.slide=function(a,b){var c=d(this),e="position top bottom left right width height".split(" "),f=d.effects.setMode(c,a.mode||"show"),g="show"===f,h=a.direction||"left",k="up"===h||"down"===h?"top":"left";h="up"===h||"left"===h;var m={};d.effects.save(c,e);c.show();var l=a.distance||c["top"===k?"outerHeight":"outerWidth"](!0);d.effects.createWrapper(c).css({overflow:"hidden"});g&&c.css(k,h?isNaN(l)?"-"+l:-l:l);m[k]=
(g?h?"+=":"-=":h?"-=":"+=")+l;c.animate(m,{queue:!1,duration:a.duration,easing:a.easing,complete:function(){"hide"===f&&c.hide();d.effects.restore(c,e);d.effects.removeWrapper(c);b()}})};d.effects.effect.transfer=function(a,b){var c=d(this),e=d(a.to),f="fixed"===e.css("position"),g=d("body"),h=f?g.scrollTop():0;g=f?g.scrollLeft():0;var k=e.offset();e={top:k.top-h,left:k.left-g,height:e.innerHeight(),width:e.innerWidth()};k=c.offset();var m=d("<div class='ui-effects-transfer'></div>").appendTo(document.body).addClass(a.className).css({top:k.top-
h,left:k.left-g,height:c.innerHeight(),width:c.innerWidth(),position:f?"fixed":"absolute"}).animate(e,a.duration,a.easing,function(){m.remove();b()})};d.widget("ui.progressbar",{version:"1.11.4",options:{max:100,value:0,change:null,complete:null},min:0,_create:function(){this.oldValue=this.options.value=this._constrainedValue();this.element.addClass("ui-progressbar ui-widget ui-widget-content ui-corner-all").attr({role:"progressbar","aria-valuemin":this.min});this.valueDiv=d("<div class='ui-progressbar-value ui-widget-header ui-corner-left'></div>").appendTo(this.element);
...
g)})},_renderItemData:function(a,b){return this._renderItem(a,b).data("ui-selectmenu-item",b)},_renderItem:function(a,b){var c=d("<li>");b.disabled&&c.addClass("ui-state-disabled");this._setText(c,b.label);return c.appendTo(a)},_setText:function(a,b){b?a.text(b):a.html("&#160;")},_move:function(a,b){var c=".ui-menu-item";if(this.isOpen)var d=this.menuItems.eq(this.focusIndex);else d=this.menuItems.eq(this.element[0].selectedIndex),c+=":not(.ui-state-disabled)";d="first"===a||"last"===a?d["first"===
a?"prevAll":"nextAll"](c).eq(-1):d[a+"All"](c).eq(0);d.length&&this.menuInstance.focus(b,d)},_getSelectedItem:function(){return this.menuItems.eq(this.element[0].selectedIndex)},_toggle:function(a){this[this.isOpen?"close":"open"](a)},_setSelection:function(){if(this.range){if(window.getSelection){var a=window.getSelection();a.removeAllRanges();a.addRange(this.range)}else this.range.select();this.button.focus()}},_documentClick:{mousedown:function(a){this.isOpen&&(d(a.target).closest(".ui-selectmenu-menu, #"+
...
"%"},{queue:!1,duration:c.animate})}a=l});else{var h=this.value();var k=this._valueMin();var m=this._valueMax();var l=m!==k?(h-k)/(m-k)*100:0;g["horizontal"===this.orientation?"left":"bottom"]=l+"%";this.handle.stop(1,1)[f?"animate":"css"](g,c.animate);if("min"===b&&"horizontal"===this.orientation)this.range.stop(1,1)[f?"animate":"css"]({width:l+"%"},c.animate);if("max"===b&&"horizontal"===this.orientation)this.range[f?"animate":"css"]({width:100-l+"%"},{queue:!1,duration:c.animate});if("min"===b&&
"vertical"===this.orientation)this.range.stop(1,1)[f?"animate":"css"]({height:l+"%"},c.animate);if("max"===b&&"vertical"===this.orientation)this.range[f?"animate":"css"]({height:100-l+"%"},{queue:!1,duration:c.animate})}},_handleEvents:{keydown:function(a){var b,c=d(a.target).data("ui-slider-handle-index");switch(a.keyCode){case d.ui.keyCode.HOME:case d.ui.keyCode.END:case d.ui.keyCode.PAGE_UP:case d.ui.keyCode.PAGE_DOWN:case d.ui.keyCode.UP:case d.ui.keyCode.RIGHT:case d.ui.keyCode.DOWN:case d.ui.keyCode.LEFT:if(a.preventDefault(),
...
0:this.offsetParent[0].scrollLeft));f&&"y"!==f||(g.top=e.top-this.offset.parent.top-this.margins.top+(this.offsetParent[0]===this.document[0].body?0:this.offsetParent[0].scrollTop));this.reverting=!0;d(this.helper).animate(g,parseInt(this.options.revert,10)||500,function(){c._clear(a)})}else this._clear(a,b);return!1}},cancel:function(){if(this.dragging){this._mouseUp({target:null});"original"===this.options.helper?this.currentItem.css(this._storedCSS).removeClass("ui-sortable-helper"):this.currentItem.show();
...
this._getItemsAsjQuery(a&&a.connected),c=[];a=a||{};b.each(function(){c.push(d(a.item||this).attr(a.attribute||"id")||"")});return c},_intersectsWith:function(a){var b=this.positionAbs.left,c=b+this.helperProportions.width,d=this.positionAbs.top,f=d+this.helperProportions.height,g=a.left,h=g+a.width,k=a.top,m=k+a.height,l=this.offset.click.top,n=this.offset.click.left;l="x"===this.options.axis||d+l>k&&d+l<m;n="y"===this.options.axis||b+n>g&&b+n<h;return"pointer"===this.options.tolerance||this.options.forcePointerForContainers||
"pointer"!==this.options.tolerance&&this.helperProportions[this.floating?"width":"height"]>a[this.floating?"width":"height"]?l&&n:g<b+this.helperProportions.width/2&&c-this.helperProportions.width/2<h&&k<d+this.helperProportions.height/2&&f-this.helperProportions.height/2<m},_intersectsWithPointer:function(a){var b="x"===this.options.axis||this._isOverAxis(this.positionAbs.top+this.offset.click.top,a.top,a.height);a="y"===this.options.axis||this._isOverAxis(this.positionAbs.left+this.offset.click.left,
...
"height";var k=c?"clientX":"clientY";for(c=this.items.length-1;0<=c;c--)if(d.contains(this.containers[f].element[0],this.items[c].item[0])&&this.items[c].item[0]!==this.currentItem[0]){var m=this.items[c].item.offset()[e];var l=!1;a[k]-m>this.items[c][h]/2&&(l=!0);Math.abs(a[k]-m)<b&&(b=Math.abs(a[k]-m),g=this.items[c],this.direction=l?"up":"down")}if(g||this.options.dropOnEmpty)this.currentContainer===this.containers[f]?this.currentContainer.containerCache.over||(this.containers[f]._trigger("over",
...
this._super(a,b),"disabled"===a&&(this.widget().toggleClass("ui-state-disabled",!!b),this.element.prop("disabled",!!b),this.buttons.button(b?"disable":"enable"))},_setOptions:I(function(a){this._super(a)}),_parse:function(a){"string"===typeof a&&""!==a&&(a=window.Globalize&&this.options.numberFormat?Globalize.parseFloat(a,10,this.options.culture):+a);return""===a||isNaN(a)?null:a},_format:function(a){return""===a?"":window.Globalize&&this.options.numberFormat?Globalize.format(a,this.options.numberFormat,
...
this.uiSpinner.replaceWith(this.element)},stepUp:I(function(a){this._stepUp(a)}),_stepUp:function(a){this._start()&&(this._spin((a||1)*this.options.step),this._stop())},stepDown:I(function(a){this._stepDown(a)}),_stepDown:function(a){this._start()&&(this._spin((a||1)*-this.options.step),this._stop())},pageUp:I(function(a){this._stepUp((a||1)*this.options.page)}),pageDown:I(function(a){this._stepDown((a||1)*this.options.page)}),value:function(a){if(!arguments.length)return this._parse(this.element.val());
I(this._value).call(this,a)},widget:function(){return this.uiSpinner}});d.widget("ui.tabs",{version:"1.11.4",delay:300,options:{active:null,collapsible:!1,event:"click",heightStyle:"content",hide:null,show:null,activate:null,beforeActivate:null,beforeLoad:null,load:null},_isLocal:function(){var a=/#.*$/;return function(b){b=b.cloneNode(!1);var c=b.href.replace(a,"");var d=location.href.replace(a,"");try{c=decodeURIComponent(c)}catch(f){}try{d=decodeURIComponent(d)}catch(f){}return 1<b.hash.length&&
...
tabIndex:-1});this.anchors=this.tabs.map(function(){return d("a",this)[0]}).addClass("ui-tabs-anchor").attr({role:"presentation",tabIndex:-1});this.panels=d();this.anchors.each(function(b,c){var e=d(c).uniqueId().attr("id"),f=d(c).closest("li"),g=f.attr("aria-controls");if(a._isLocal(c)){var l=c.hash;var n=l.substring(1);l=a.element.find(a._sanitizeSelector(l))}else n=f.attr("aria-controls")||d({}).uniqueId()[0].id,l=a.element.find("#"+n),l.length||(l=a._createPanel(n),l.insertAfter(a.panels[b-1]||
a.tablist)),l.attr("aria-live","polite");l.length&&(a.panels=a.panels.add(l));g&&f.data("ui-tabs-aria-controls",g);f.attr({"aria-controls":n,"aria-labelledby":e});l.attr("aria-labelledby",e)});this.panels.addClass("ui-tabs-panel ui-widget-content ui-corner-bottom").attr("role","tabpanel");b&&(this._off(b.not(this.tabs)),this._off(c.not(this.anchors)),this._off(e.not(this.panels)))},_getList:function(){return this.tablist||this.element.find("ol,ul").eq(0)},_createPanel:function(a){return d("<div>").attr("id",
...
if(!0!==b){if(void 0===a)b=!0;else{a=this._getIndex(a);if(-1!==d.inArray(a,b))return;b=d.isArray(b)?d.merge([a],b).sort():[a]}this._setupDisabled(b)}},load:function(a,b){a=this._getIndex(a);var c=this,e=this.tabs.eq(a),f=e.find(".ui-tabs-anchor"),g=this._getPanelForTab(e),h={tab:e,panel:g},k=function(a,b){"abort"===b&&c.panels.stop(!1,!0);e.removeClass("ui-tabs-loading");g.removeAttr("aria-busy");a===c.xhr&&delete c.xhr};this._isLocal(f[0])||(this.xhr=d.ajax(this._ajaxSettings(f,b,h)))&&"canceled"!==
this.xhr.statusText&&(e.addClass("ui-tabs-loading"),g.attr("aria-busy","true"),this.xhr.done(function(a,d,e){setTimeout(function(){g.html(a);c._trigger("load",b,h);k(e,d)},1)}).fail(function(a,b){setTimeout(function(){k(a,b)},1)}))},_ajaxSettings:function(a,b,c){var e=this;return{url:a.attr("href"),beforeSend:function(a,g){return e._trigger("beforeLoad",b,d.extend({jqXHR:a,ajaxSettings:g},c))}}},_getPanelForTab:function(a){a=d(a).attr("aria-controls");return this.element.find(this._sanitizeSelector("#"+
...
_setOption:function(a,b){var c=this;"disabled"===a?(this[b?"_disable":"_enable"](),this.options[a]=b):(this._super(a,b),"content"===a&&d.each(this.tooltips,function(a,b){c._updateContent(b.element)}))},_disable:function(){var a=this;d.each(this.tooltips,function(b,c){var e=d.Event("blur");e.target=e.currentTarget=c.element[0];a.close(e,!0)});this.element.find(this.options.items).addBack().each(function(){var a=d(this);a.is("[title]")&&a.data("ui-tooltip-title",a.attr("title")).removeAttr("title")})},
